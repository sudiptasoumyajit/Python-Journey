...
def draw(direction,oldx,oldy,newx,newy):
    ...
    if(direction=='right'):
        right_line=canvas.create_line(oldx,oldy,newx,newy,width=2,fill=fill_color)
    if(direction=='left'):
        left_line=canvas.create_line(oldx,oldy,newx,newy,width=2,fill=fill_color)
    if(direction=='up'):
        up_line=canvas.create_line(oldx,oldy,newx,newy,width=2,fill=fill_color)
    if(direction=='down'):
        down_line=canvas.create_line(oldx,oldy,newx,newy,width=2,fill=fill_color)
